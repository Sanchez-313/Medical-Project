      ...
      <div className="relative flex min-h-[600px] w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        >
          ...
          <div className="relative z-10 text-[10px] text-blue-200/50 uppercase tracking-[0.3em] font-bold">
            HIPAA Compliant &bull; Secure Access
          </div>
        </section>
          ...
          <div className="w-full max-w-md">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center gap-3 py-1">
                ...
                <label htmlFor="remember" className="text-xs font-semibold text-slate-500 cursor-pointer">Keep me Log In</label>
              </div>
            ...
            <footer className="mt-12 text-center">
              <div className="relative mb-6 flex items-center justify-center">
                ...
                <span className="relative bg-white px-4 text-[10px] font-bold uppercase tracking-widest text-slate-400">Verified Health Login</span>
              </div>
