...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="bg-white p-5 rounded-3xl relative overflow-hidden group transition-all duration-300 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1">
      ...
      <div className="relative z-10 w-full h-40 mt-10 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50">
        {product.image_url && (
          <Image
      ...
      <div className="relative z-10 text-center mt-6">
        ...
        >
          ...
          {isOutOfStock ? "Out of stock" : `${product.stock_qty} available`}
        </p>
