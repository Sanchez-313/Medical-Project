  ...
  return (
    ...
    >
      <div className="px-5 sm:px-10">
        <h3 className="text-2xl sm:text-3xl font-bold text-zinc-800 text-center">{t("cart.yourCart")}</h3>
      </div>

      <div className="flex-1 overflow-y-auto">
        {cartItems.length === 0 ? (
          <div className="px-5 py-12 text-center text-zinc-500 sm:px-10">{t("cart.empty")}</div>
        ) : (
          cartItems.map((item) => (
      ...
      <div className="px-5 sm:px-10 border-y border-zinc-300">
      ...
      <div className="flex gap-x-2 px-5 sm:px-10">
