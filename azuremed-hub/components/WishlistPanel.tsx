  ...
  return (
    ...
    >
      <div className="px-5 sm:px-10">
        <h3 className="text-2xl sm:text-3xl font-bold text-zinc-800 text-center">{t("wishlist.yourWishlist")}</h3>
      </div>

      <div className="flex-1 overflow-y-auto">
        {wishlistItems.length === 0 ? (
          <div className="px-5 py-12 text-center text-zinc-500 sm:px-10">{t("wishlist.empty")}</div>
        ) : (
