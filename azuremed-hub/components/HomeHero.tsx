...
export default function HomeHero({ totalProducts, categoryCount }: { totalProducts: number; categoryCount: number }) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="relative min-h-screen max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 flex md:flex-row flex-col items-center pt-28 sm:pt-32 md:pt-28">
        <div className="flex-1">
          ...
          <h1 className="text-4xl/[1.1] sm:text-5xl/[1.1] md:text-7xl/[1.05] font-extrabold mt-6 tracking-tight text-zinc-900">
            {t("hero.titlePrefix")}{" "}
          ...
          <div className="flex flex-col gap-3 mb-10 sm:flex-row sm:flex-wrap sm:gap-4">
            <Link
              href="/products"
              className="bg-gradient-to-b from-blue-500 to-blue-600 text-center text-white px-6 sm:px-8 py-3.5 rounded-lg md:text-lg text-md hover:scale-105 hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg shadow-blue-200 inline-block font-semibold"
            >
              {t("hero.browseProducts")}
            </Link>
            <Link
              href="/detect-medicine"
              className="bg-white text-center text-blue-700 px-6 sm:px-8 py-3.5 rounded-lg md:text-lg text-md hover:scale-105 transition-all duration-300 shadow-md ring-1 ring-blue-200 inline-block font-semibold"
            >
        ...
        <div className="flex-1 mt-8 md:mt-0 relative h-[280px] sm:h-[320px] md:h-[420px] w-full">
