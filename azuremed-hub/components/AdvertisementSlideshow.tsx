...
export default function AdvertisementSlideshow() {
  ...
  return (
    <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 pt-4">
      <Swiper
      ...
      >
        {ads.map((ad) => {
          ...
          const content = (
              <div className="relative h-[240px] sm:h-[220px] md:h-[300px] w-full">
              <Image
                src={ad.image_url}
                alt={title}
                fill
              ...
              <div className="relative z-10 flex h-full max-w-xl flex-col justify-center gap-3 px-5 sm:px-8 md:px-12">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-white drop-shadow-sm">{title}</h2>
                {description && (
