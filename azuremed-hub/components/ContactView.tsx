...
export default function ContactView({ isSignedIn }: { isSignedIn: boolean }) {
  ...
  return (
    <div className="pt-32 pb-20">
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 text-center">
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-10 mt-16 text-center">
