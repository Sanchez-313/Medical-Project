...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 pb-16 pt-24 sm:pt-32">
      <main className="max-w-7xl mx-auto px-4 py-6 sm:py-8 lg:px-8">
        <div className="mb-10">
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-slate-900 mb-2">{t("checkout.heading")}</h1>
          <p className="text-slate-500">{t("checkout.subheading")}</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          <div className="lg:col-span-7 space-y-6 sm:space-y-10">
            <section className="bg-white p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] shadow-sm border border-slate-100">
              <div className="flex items-center gap-3 mb-8">
                <div className="p-3 bg-blue-50 text-blue-600 rounded-2xl">
                  <Truck size={24} />
                </div>
                <h2 className="text-xl sm:text-2xl font-black">{t("checkout.shippingDetails")}</h2>
              </div>
            ...
            <section className="bg-white p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] shadow-sm border border-slate-100">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-xl sm:text-2xl font-black">{t("checkout.paymentMethod")}</h2>
              </div>
