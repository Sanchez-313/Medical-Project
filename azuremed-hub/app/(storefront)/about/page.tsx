...
export default function AboutPage() {
  ...
  return (
    <div className="pt-32 pb-20">
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div>
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 mt-16 sm:mt-20">
