    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <Link
          ...
          className="group flex items-center gap-5 rounded-[2rem] border border-orange-100 bg-white p-6 shadow-sm transition-all hover:border-orange-300 hover:shadow-md"
        >
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-xs font-bold text-orange-600 group-hover:underline">View low-stock products</p>
          </div>
        </Link>
      </div>
